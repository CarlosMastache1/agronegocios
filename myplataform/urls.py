...
urlpatterns = [
    ...
    path('productosProductorAcuicola/<str:categoria>/<str:nombre>', views.productorProductorAcui, name="productosProductorAcuicola"),
    ...
    path('paginaProductosOaxaca/', views.tabla_precios, name='paginaProductosOaxaca'),
