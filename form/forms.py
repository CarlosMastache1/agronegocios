...
class productosForm(forms.ModelForm):
    class Meta:
        model = productos
        fields = [ 'nombreProductor',  'municipio' , 'localidad', 'nombreProducto', 'nombreMarca', 'subsector', 'categoria', 'volumen_produccion', 'disponibilidad_entrega', 'telefono', 'email', 'imagenProd'
        ]
