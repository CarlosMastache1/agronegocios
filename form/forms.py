...
class financieras(forms.ModelForm):
    ...
    'status',
        ...
        widgets={
            ...
            'producto_tipoCredito' : forms.TextInput(attrs={'class' : 'form-control'}),
            ...
            'inclumplimiento_credito' : forms.TextInput(attrs={'class' : 'form-control'}),
            ...
            'tipo_concepto' : forms.TextInput(attrs={'class' : 'form-control'}),
            'descripcion_concepto' : forms.TextInput(attrs={'class' : 'form-control'}), 
            'subsector' : forms.TextInput(attrs={'class' : 'form-control'}),
