...
class entidadesFinancieras2(models.Model):
    ...
    tipo_persona = models.CharField(max_length=30, blank=True, null=True, choices= personas) 
    ...
    periodo_pago = models.CharField(max_length=50, blank=True, null=True, choices=periodos) 
    ...
    subsector = models.CharField(max_length=50, blank=True, null=True, choices=subsectores) 
